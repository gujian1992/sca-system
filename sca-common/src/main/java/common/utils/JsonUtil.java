...
public class JsonUtil {
    ...
    public static String object2Json(Object o) {
        ...
        try {
            ...
            log.warn("object to com.ruyuan.eshop.common.common.json error", e);
        }
        return s;
    }
    ...
    public static <T> T json2Object(String json, Class<T> clazz) {
        ...
        try {
            ...
            log.warn("com.ruyuan.eshop.common.common.json to object error", e);
        }
        return null;
    }
    ...
    public <T> T getData(Object data, Class<T> clazz) {
        ...
        try {
            ...
            log.warn("com.ruyuan.eshop.common.common.json data process error", e);
        }
        return null;
    }
